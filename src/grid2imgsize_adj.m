function im_out = grid2imgsize_adj(im, st, ht, M)

% The adjoint operator implemented here is:
% Phi = S'Z'F'G'GFZS
...
% Input argument is an 'image'-styled visibility of size [Ny*Nx, 1]
...
xo = 0; yo = 0;
imc(yo+1:yo+Ny1,xo+1:xo+Nx1) = st.sn .* (reshape(im, Ny1, Nx1)); % Scaling
