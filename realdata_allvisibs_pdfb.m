...
filename = sprintf('results/allvisibs/i%d.dl%d.n%05d.eps%d.gamma%d.hyperspec.q6-5-51.allvisibs.', param_real_data.image_size_Ny, (10*param_real_data.pixel_size), param_pdfb.max_iter, step_epsilon, abs(log10(param_pdfb.gamma)));
